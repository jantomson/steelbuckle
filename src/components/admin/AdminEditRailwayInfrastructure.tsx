...
const AdminEditRailwayInfrastructure = () => {
  ...
  const fetchCurrentImage = async () => {
    ...
    try {
      const response = await fetch(
        `/api/media?keys=railway_infrastructure_page.images.main_image&pageId=railway_infrastructure_page&_t=${Date.now()}`
      );
      if (response.ok) {
        const data = await response.json();
        if (data["railway_infrastructure_page.images.main_image"]) {
          setCurrentImageUrl(
            data["railway_infrastructure_page.images.main_image"]
          );
  ...
  useEffect(() => {
    const handleMediaUpdate = () => {
      console.log("AdminEditRailwayInfrastructure: Media update detected");
  ...
  useEffect(() => {
    if (
      ...
      mediaConfig["railway_infrastructure_page.images.main_image"]
    ) {
      const newUrl =
        mediaConfig["railway_infrastructure_page.images.main_image"] ||
        mediaConfig["main_image"];
  ...
  const getMainImageUrl = () => {
    ...
    if (isEditMode) {
      const editedUrl = editContext.getMediaUrl(
        "railway_infrastructure_page.images.main_image",
        ""
      );
  ...
  return (
    <div className="w-full bg-white font-[family-name:var(--font-geist-sans)]">
      ...
      <AdminSubpageHeader titlePath="railway_infrastructure_page.title" />
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 py-12 mb-10 mt-10">
        ...
        <div className="max-w-2xl mx-auto mb-16">
          <p className="text-md font-semibold text-gray-500 text-center leading-relaxed">
            <EditableText path="railway_infrastructure_page.intro" />
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 pt-10">
          ...
          <div>
            <h2 className="text-2xl font-medium mb-8 text-black">
              <EditableText path="railway_infrastructure_page.services.title" />
            </h2>
            ...
            <div className="space-y-6 mt-10">
              <div className="flex items-start gap-4">
                ...
                <span className="text-md font-semibold text-gray-500 mb-2">
                  <EditableText path="railway_infrastructure_page.services.items.1" />
                </span>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <span className="text-md font-semibold text-gray-500 mb-2">
                  <EditableText path="railway_infrastructure_page.services.items.2" />
                </span>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <span className="text-md font-semibold text-gray-500 mb-2">
                  <EditableText path="railway_infrastructure_page.services.items.3" />
                </span>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <span className="text-md font-semibold text-gray-500 mb-2">
                  <EditableText path="railway_infrastructure_page.services.items.4" />
                </span>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <span className="text-md font-semibold text-gray-500 mb-2">
                  <EditableText path="railway_infrastructure_page.services.items.5" />
                </span>
              </div>
            </div>
          </div>
        ...
        {/* Divider */}
        <div className="border-t border-gray-200 my-12 pb-10"></div>

        {/* Bottom text sections */}
        <div className="max-w-3xl mx-auto text-center space-y-6 text-md font-semibold text-gray-500 mb-2">
          <p>
            <EditableText path="railway_infrastructure_page.bottom_sections.section1" />
          </p>

          <p>
            <EditableText path="railway_infrastructure_page.bottom_sections.section2" />
          </p>
        </div>
        ...
        <div className="mt-16 flex justify-center">
          <button className="inline-flex items-center bg-black text-white px-6 py-2 rounded-full w-fit hover:bg-gray-600 transition-colors">
            <EditableText path="railway_infrastructure_page.cta" />
...
export default AdminEditRailwayInfrastructure;
